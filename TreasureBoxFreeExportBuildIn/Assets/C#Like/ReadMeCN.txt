...
v 2024.3
功能
- 新增部分提示:使用了部分免费版不支持但完整版支持的功能,在Console面板提示了
- 新增把非热更新项目改造成热更新项目的演示:'Tanks! Tutorial'和'Platformer Microgame'(项目已上传至GitHub)
修正
- 修正序列化在调试模式下异常.
- 现在在Awake函数前正确地序列化LikeBehaviour类型的字段了(原来只能在Start函数前才能获取到).

v 2024.2
功能
- 序列化字段新增支持数组,例如'Transform[] transforms'
修正
- 修正断点调试功能异常.
- 修正新版序列化字段在编辑器修改时候不会即时刷新至内存
- 修正新版序列化字段的List且基类为'UnityEngine.Object'类或'LikeBehaviour'类的异常,例如'List&lt;Transform> transforms'.
- 修正脚本错误CS0023
