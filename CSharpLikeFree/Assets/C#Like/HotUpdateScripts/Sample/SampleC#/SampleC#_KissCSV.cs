...
namespace CSharpLike
{
    public partial class SampleCSharp : LikeBehaviour
    {
        ...
        void TestKissCSV()
        {
            ...
            KissCSV.Load(typeof(TestCsv), "TestCsv", "id", ResourceManager.LoadAsset<TextAsset>("Assets/C#Like/Sample/CSV/TestCsv.csv").text);
            ...
            SimpleKissCSV.LoadWithFileContent("Item.csv", "id", ResourceManager.LoadAsset<TextAsset>("Assets/C#Like/Sample/CSV/Item.csv").text);
